...
t_status string_instance_delete( t_string * p_string )
{
  t_status	st;
...
t_status string_instance_create( const char * p_initial_string, t_string * p_string )
{
  t_status	st;
  t_size	len;
...
t_status string_instance_clone( t_string * ps_old, t_string * ps_new )
{
  t_status	st;
...
t_status string_instance_put( const char * message, t_string * p_string )
{
  t_status	st;
  t_size	len;
...
t_status string_instance_set( const char * message, t_string * p_string )
{
  t_status	st;
  t_size	len;
...
t_status string_instance_size( t_string * p_string, t_size * p_size )
{
  t_status	st;
...
t_status string_instance_print( t_string * p_string )
{
  t_status	st;
...
t_status string_message_get( t_string * p_string, t_size maxSize, char * message )
{
  t_status	st;
...
t_status string_instances_concat( t_string * ps_str1, t_string * ps_str2, t_string * ps_final )
{
  t_status	st;
...
t_status string_instances_compare( t_string * ps_str1, t_string * ps_str2, Byte * p_result )
{
  t_status	st;
...
t_status string_instances_equal( t_string * ps_str1, t_string * ps_str2, _Bool * p_result )
{
  t_status	st;
...
t_status string_instances_compareIcase( t_string * ps_str1, t_string * ps_str2, Byte * p_result )
{
  t_status	st;
